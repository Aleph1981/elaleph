...
class MenuPrincipal(QtWidgets.QMainWindow, MenuPrincipal_Ui):
    ...
    #-------------------Acciones del menu------------------------------------------
        ...
        ctx = ConfigCtx()
        self.carpeta_logos = ctx.readvar("RUTAS", "logos")
        app.setWindowIcon(QtGui.QIcon(self.carpeta_logos+'aleph.ico'))
        self.setWindowIcon(QtGui.QIcon(self.carpeta_logos+'aleph.ico'))
        logoaleph = QtGui.QPixmap(self.carpeta_logos+"logo_aleph.png")
        self.logo.setPixmap(logoaleph)
        self.logo.setScaledContents(False)
        
        logoempresa = QtGui.QPixmap(self.carpeta_logos+"logo_empresa.png")
        self.logo_2.setPixmap(logoempresa)
