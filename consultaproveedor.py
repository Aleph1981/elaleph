...
class ConsultaProveedor(QtWidgets.QWidget, ConsultaProveedor_Ui):
    ...
    def __init__(self, app):
        ...
        self.ui.tableProveedor.cellDoubleClicked.connect(self.edit_proveedor)
        ...
        self.setWindowTitle("Aleph - Consulta de proveedores")
    ...
    def combo_servicios(self):   
        bd=BdStd()
        bd.runsql("SELECT servicio FROM servicios ORDER BY orden")
