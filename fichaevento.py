...
class FichaEvento(QtWidgets.QWidget, FichaEvento_Ui):
    ...
    def __init__(self,id_evento):
        ...
        self.setWindowTitle("Aleph - Ficha de evento")
        ...
        self.ui.tableProveedores.setColumnCount(8)
        self.ui.tableProveedores.setHorizontalHeaderLabels([ "Fecha", "Servicio", "ID","Localidad", "Contacto",  
...
if __name__ == "__main__":
    ...
    ui = FichaEvento("JB-784-2021-RLA")
    ui.show()
    sys.exit(app.exec_())